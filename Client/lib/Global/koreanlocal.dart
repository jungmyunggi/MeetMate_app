...
// 부산
['강서구', '금정구', '기장군', '남구(부산)', '동구(부산)', '동래구', '부산진구', '북구(부산)', '사상구', '사하구', '서구(부산)', '수영구', '연제구', '영도구', '중구(부산)', '해운대구'],

// 대구
['남구(대구)', '달서구', '달성군', '동구(대구)', '북구(대구)', '서구(대구)', '수성구'],

// 인천
['강화군', '계양구', '미추홀구', '남동구', '동구(인천)', '부평구', '서구(인천)', '연수구', '옹진군'],

// 광주
['광산구', '남구(광주)', '동구(광주)', '북구(광주)', '서구(광주)'],

// 대전
['대덕구', '동구(대전)', '서구(대전)', '유성구'],

// 울산
['남구(울산)', '동구(울산)', '북구(울산)', '울주군', '중구(울산)'],
...
// 경북
  ['경산시', '경주시', '고령군', '구미시', '군위군', '김천시', '문경시', '봉화군', '상주시', '성주군', '안동시', '영덕군', '영양군', '영주시', '영천시', '예천군', '울릉군', '울진군', '의성군', '청도군', '청송군', '칠곡군'],
